    ...
    font-family: 'Concert One', cursive;" class="nav-link active" href="./terminar.php">Cerrar Sesion</a></li>
              ...
              ?>
                ...
                <h3>Metodos de pago</h3>
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="button" class="btn btn-info" name="pagotarjeta" id="pagotarjeta" value="Pagar con tarjeta"></input>
                        ...
                        <div class="col">
                        <input type="button" class="btn btn-danger" name="pagooxo" id="pagooxo" value="Pagar en oxxo"></input>
                        <br>
